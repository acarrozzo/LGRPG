...
while ($row = $result->fetch_assoc()) {
    ...
    echo '<section  data-pop="inv" class="panelXXX" id="weap">';
        ...
        echo '<div class="gbox">
        <h2>Auto-Equip</h2>
        <p class="gold">Equip the best weapons and armor to max out a specific stat. You can also manually change equipped items below.</p>
    ...
    <a href="" data-link2="armor" class="ddgrayBG btn">Armor ></a>
    ...
    if ($row["dagger"] > 0) {
        ...
        if ($row["equipR"] == "dagger") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip dagger' /> ";
        }
    ...
    if ($row["stiletto"] > 0) {
        echo "<div>";
        if ($row["equipR"] == "stiletto") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip stiletto' /> ";
        }
    ...
    if ($row["trainingsword"] > 0) {
        ...
        if ($row["equipR"] == "training sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip training sword' /> ";
        }
    ...
    if ($row["shortsword"] > 0) {
        ...
        if ($row["equipR"] == "short sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip short sword' /> ";
        }
    ...
    if ($row["mace"] > 0) {
        ...
        if ($row["equipR"] == "mace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mace' /> ";
        }
    ...
    if ($row["broadsword"] > 0) {
        ...
        if ($row["equipR"] == "broad sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip broad sword' /> ";
        }
    ...
    if ($row["longsword"] > 0) {
        ...
        if ($row["equipR"] == "long sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip long sword' /> ";
        }
    ...
    if ($row["club"] > 0) {
        ...
        if ($row["equipR"] == "club") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip club' /> ";
        }
    ...
    if ($row["flail"] > 0) {
        ...
        if ($row["equipR"] == "flail") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip flail' /> ";
        }
    ...
    if ($row["morningstar"] > 0) {
        ...
        if ($row["equipR"] == "morning star") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip morning star' /> ";
        }
    ...
    if ($row["samuraisword"] > 0) {
        ...
        if ($row["equipR"] == "samurai sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip samurai sword' /> ";
        }
    ...
    if ($row["gladius"] > 0) {
        ...
        if ($row["equipR"] == "gladius") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip gladius' /> ";
        }
    ...
    if ($row["basicstaff"] > 0) {
        ...
        if ($row["equipR"] == "basic staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip basic staff' /> ";
        }
    ...
    if ($row["woodenstaff"] > 0) {
        ...
        if ($row["equipR"] == "wooden staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip wooden staff' /> ";
        }
    ...
    if ($row["wand"] > 0) {
        ...
        if ($row["equipR"] == "wand") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip wand' /> ";
        }
    ...
    if ($row["wizardstaff"] > 0) {
        ...
        if ($row["equipR"] == "wizard staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip wizard staff' /> ";
        }
    ...
    if ($row["demondagger"] > 0) {
        ...
        if ($row["equipR"] == "demon dagger") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip demon dagger' /> ";
        }
    ...
    if ($row["graywand"] > 0) {
        ...
        if ($row["equipR"] == "gray wand") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip gray wand' /> ";
        }
    ...
    if ($row["threechainedflail"] > 0) {
        ...
        if ($row["equipR"] == "three-chained flail") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip three-chained flail' /> ";
        }
    ...
    if ($row["bastardsword"] > 0) {
        ...
        if ($row["equipR"] == "bastard sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bastard sword' /> ";
        }
    ...
    if ($row["giantclub"] > 0) {
        ...
        if ($row["equipR"] == "giant club") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip giant club' /> ";
        }
    ...
    if ($row["greatwhitesword"] > 0) {
        ...
        if ($row["equipR"] == "great white sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip great white sword' /> ";
        }
    ...
    if ($row["masterblade"] > 0) {
        ...
        if ($row["equipR"] == "master blade") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip master blade' /> ";
        }
    ...
    if ($row["irondagger"] > 0) {
        ...
        if ($row["equipR"] == "iron dagger") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron dagger' /> ";
        }
    ...
    if ($row["ironsword"] > 0) {
        ...
        if ($row["equipR"] == "iron sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron sword' /> ";
        }
    ...
    if ($row["ironstaff"] > 0) {
        ...
        if ($row["equipR"] == "iron staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron staff' /> ";
        }
    ...
    if ($row["poisonsaber"] > 0) {
        ...
        if ($row["equipR"] == "poison saber") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip poison saber' /> ";
        }
    ...
    if ($row["ulfberht"] > 0) {
        ...
        if ($row["equipR"] == "ulfberht") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ulfberht' /> ";
        }
    ...
    if ($row["waraxe"] > 0) {
        echo "<div>";
        if ($row["equipR"] == "war axe") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip war axe' /> ";
        }
    ...
    if ($row["perfectsword"] > 0) {
        echo "<div>";
        if ($row["equipR"] == "perfect sword") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip perfect sword' /> ";
        }
    ...
    if ($row["silversword"] > 0) {
        ...
        if ($row["equipR"] == "silver sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver sword' /> ";
        }
    ...
    if ($row["silverstaff"] > 0) {
        ...
        if ($row["equipR"] == "silver staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver staff' /> ";
        }
    ...
    if ($row["silverwhip"] > 0) {
        ...
        if ($row["equipR"] == "silver whip") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver whip' /> ";
        }
    ...
    if ($row["kingsscepter"] > 0) {
        echo "<div>";
        if ($row["equipR"] == "kings scepter") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip kings scepter' /> ";
        }
    ...
    *100k silver whip ( +25 str, +25 mag )		// only found in silver chest
    ...
    if ($row["sharpkatana"] > 0) {
        ...
        if ($row["equipR"] == "sharp katana") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip sharp katana' /> ";
        }
    ...
    if ($row["blackblade"] > 0) {
        ...
        if ($row["equipR"] == "black blade") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip black blade' /> ";
        }
    ...
    if ($row["forestsaber"] > 0) {
        ...
        if ($row["equipR"] == "forest saber") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip forest saber' /> ";
        }
    ...
    if ($row["flamberg"] > 0) {
        ...
        if ($row["equipR"] == "flamberg") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip flamberg' /> ";
        }
    ...
    if ($row["guardianblade"] > 0) {
        ...
        if ($row["equipR"] == "guardian blade") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip guardian blade' /> ";
        }
    ...
    if ($row["gammaknife"] > 0) {
        ...
        if ($row["equipR"] == "gamma knife") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip gamma knife' /> ";
        }
    ...
    if ($row["trainingshield"] > 0) {
        ...
        if ($row["equipL"] == "training shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip training shield' /> ";
        }
    ...
    if ($row["basicshield"] > 0) {
        ...
        if ($row["equipL"] == "basic shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip basic shield' /> ";
        }
    ...
    if ($row["kiteshield"] > 0) {
        ...
        if ($row["equipL"] == "kite shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip kite shield' /> ";
        }
    ...
    if ($row["buckler"] > 0) {
        ...
        if ($row["equipL"] == "buckler") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip buckler' /> ";
        }
    ...
    if ($row["woodenshield"] > 0) {
        ...
        if ($row["equipL"] == "wooden shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip wooden shield' /> ";
        }
    ...
    if ($row["huntershield"] > 0) {
        ...
        if ($row["equipL"] == "hunter shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip hunter shield' /> ";
        }
    ...
    if ($row["offhanddagger"] > 0) {
        ...
        if ($row["equipL"] == "off hand dagger") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip off hand dagger' /> ";
        }
    ...
    if ($row["towershield"] > 0) {
        ...
        if ($row["equipL"] == "tower shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip tower shield' /> ";
        }
    ...
    if ($row["glowingorb"] > 0) {
        ...
        if ($row["equipL"] == "glowing orb") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip glowing orb' /> ";
        }
    ...
    if ($row["enchantedorb"] > 0) {
        ...
        if ($row["equipL"] == "enchanted orb") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip enchanted orb' /> ";
        }
    ...
    if ($row["ironshield"] > 0) {
        ...
        if ($row["equipL"] == "iron shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron shield' /> ";
        }
    ...
    if ($row["ironkiteshield"] > 0) {
        ...
        if ($row["equipL"] == "iron kite shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron kite shield' /> ";
        }
    ...
    if ($row["redshield"] > 0) {
        ...
        if ($row["equipL"] == "red shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip red shield' /> ";
        }
    ...
    if ($row["deathorb"] > 0) {
        ...
        if ($row["equipL"] == "death orb") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip death orb' /> ";
        }
    ...
    if ($row["greenshield"] > 0) {
        ...
        if ($row["equipL"] == "green shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip green shield' /> ";
        }
    ...
    if ($row["silvershield"] > 0) {
        ...
        if ($row["equipL"] == "silver shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver shield' /> ";
        }
    ...
    if ($row["vikingshield"] > 0) {
        ...
        if ($row["equipL"] == "viking shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip viking shield' /> ";
        }
    ...
    if ($row["greenorb"] > 0) {
        ...
        if ($row["equipL"] == "green orb") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip green orb' /> ";
        }
    ...
    if ($row["offhandsword"] > 0) {
        ...
        if ($row["equipL"] == "off hand sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip off hand sword' /> ";
        }
    ...
    if ($row["riotshield"] > 0) {
        ...
        if ($row["equipL"] == "riot shield") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip riot shield' /> ";
        }
    ...
    if ($row["offhandmace"] > 0) {
        ...
        if ($row["equipL"] == "off hand mace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip off hand mace' /> ";
        }
    ...
    if ($row["training2hsword"] > 0) {
        ...
        if ($row["equipR"] == "training 2h sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip training 2h sword' /> ";
        }
    ...
    if ($row["bo"] > 0) {
        ...
        if ($row["equipR"] == "bo") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bo' /> ";
        }
    ...
    if ($row["battleaxe"] > 0) {
        ...
        if ($row["equipR"] == "battle axe") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip battle axe' /> ";
        }
    ...
    if ($row["warhammer"] > 0) {
        ...
        if ($row["equipR"] == "warhammer") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip warhammer' /> ";
        }
    ...
    if ($row["woodenbo"] > 0) {
        ...
        if ($row["equipR"] == "wooden bo") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip wooden bo' /> ";
        }
    ...
    if ($row["pike"] > 0) {
        ...
        if ($row["equipR"] == "pike") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip pike' /> ";
        }
    ...
    if ($row["claymore"] > 0) {
        ...
        if ($row["equipR"] == "claymore") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip claymore' /> ";
        }
    ...
    if ($row["greatsword"] > 0) {
        ...
        if ($row["equipR"] == "great sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip great sword' /> ";
        }
    ...
    if ($row["bostaff"] > 0) {
        ...
        if ($row["equipR"] == "bo staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bo staff' /> ";
        }
    ...
    if ($row["battlestaff"] > 0) {
        ...
        if ($row["equipR"] == "battle staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip battle staff' /> ";
        }
    ...
    if ($row["dualtomahawk"] > 0) {
        ...
        if ($row["equipR"] == "dual tomahawk") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip dual tomahawk' /> ";
        }
    ...
    if ($row["nunchaku"] > 0) {
        ...
        if ($row["equipR"] == "nunchaku") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip nunchaku' /> ";
        }
    ...
    if ($row["brassknuckles"] > 0) {
        echo "<div>";
        if ($row["equipR"] == "brass knuckles") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip brass knuckles' /> ";
        }
    ...
    if ($row["polearm"] > 0) {
        ...
        if ($row["equipR"] == "polearm") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip polearm' /> ";
        }
    ...
    if ($row["bonecudgel"] > 0) {
        ...
        if ($row["equipR"] == "bone cudgel") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bone cudgel' /> ";
        }
    ...
    if ($row["hammerheadhammer"] > 0) {
        ...
        if ($row["equipR"] == "hammerhead hammer") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip hammerhead hammer' /> ";
        }
    ...
    if ($row["ironmaul"] > 0) {
        ...
        if ($row["equipR"] == "iron maul") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron maul' /> ";
        }
    ...
    if ($row["iron2hsword"] > 0) {
        ...
        if ($row["equipR"] == "iron 2h sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron 2h sword' /> ";
        }
    ...
    if ($row["ironbattlestaff"] > 0) {
        ...
        if ($row["equipR"] == "iron battle staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron battle staff' /> ";
        }
    ...
    if ($row["ironnunchaku"] > 0) {
        ...
        if ($row["equipR"] == "iron nunchaku") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron nunchaku' /> ";
        }
    ...
    if ($row["greataxe"] > 0) {
        ...
        if ($row["equipR"] == "great axe") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip great axe' /> ";
        }
    ...
    if ($row["trident"] > 0) {
        ...
        if ($row["equipR"] == "trident") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip trident' /> ";
        }
    ...
    if ($row["solomonsstaff"] > 0) {
        echo "<div>";
        if ($row["equipR"] == "solomon's staff") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip solomons staff' /> ";
        }
    ...
    if ($row["oakbattlestaff"] > 0) {
        ...
        if ($row["equipR"] == "oak battle staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip oak battle staff' /> ";
        }
    ...
    if ($row["jimbo"] > 0) {
        ...
        if ($row["equipR"] == "jim bo") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip jim bo' /> ";
        }
    ...
    if ($row["silver2hsword"] > 0) {
        ...
        if ($row["equipR"] == "silver 2h sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver 2h sword' /> ";
        }
    ...
    if ($row["steel2hsword"] > 0) {
        ...
        if ($row["equipR"] == "steel 2h sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel 2h sword' /> ";
        }
    ...
    if ($row["steelbattlestaff"] > 0) {
        ...
        if ($row["equipR"] == "steel battle staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel battle staff' /> ";
        }
    ...
    if ($row["steelnunchaku"] > 0) {
        ...
        if ($row["equipR"] == "steel nunchaku") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel nunchaku' /> ";
        }
    ...
    if ($row["heavykatana"] > 0) {
        ...
        if ($row["equipR"] == "heavy katana") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip heavy katana' /> ";
        }
    ...
    if ($row["heavyspear"] > 0) {
        ...
        if ($row["equipR"] == "heavy spear") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip heavy spear' /> ";
        }
    ...
    if ($row["heavyhammer"] > 0) {
        ...
        if ($row["equipR"] == "heavy hammer") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip heavy hammer' /> ";
        }
    ...
    if ($row["oakwarhammer"] > 0) {
        ...
        if ($row["equipR"] == "oak warhammer") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip oak warhammer' /> ";
        }
    ...
    if ($row["bardiche"] > 0) {
        ...
        if ($row["equipR"] == "bardiche") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bardiche' /> ";
        }
    ...
    if ($row["glaive"] > 0) {
        ...
        if ($row["equipR"] == "glaive") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip glaive' /> ";
        }
    ...
    if ($row["perfect2hsword"] > 0) {
        echo "<div>";
        if ($row["equipR"] == "perfect 2h sword") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip perfect 2h sword' /> ";
        }
    ...
    if ($row["mithril2hsword"] > 0) {
        ...
        if ($row["equipR"] == "mithril 2h sword") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mithril 2h sword' /> ";
        }
    ...
    if ($row["mithrilbattlestaff"] > 0) {
        ...
        if ($row["equipR"] == "mithril battle staff") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mithril battle staff' /> ";
        }
    ...
    if ($row["mithrilnunchaku"] > 0) {
        ...
        if ($row["equipR"] == "mithril nunchaku") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mithril nunchaku' /> ";
        }
    ...
    if ($row["humongousbattleaxe"] > 0) {
        ...
        if ($row["equipR"] == "humongous battleaxe") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip humongous battleaxe' /> ";
        }
    ...
    if ($row["gargantuanwarhammer"] > 0) {
        ...
        if ($row["equipR"] == "gargantuan warhammer") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip gargantuan warhammer' /> ";
        }
    ...
    if ($row["blessedspear"] > 0) {
        ...
        if ($row["equipR"] == "blessed spear") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip blessed spear' /> ";
        }
    ...
    if ($row["fortifiedfauchard"] > 0) {
        ...
        if ($row["equipR"] == "fortified fauchard") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip fortified fauchard' /> ";
        }
    ...
    echo "<h2>Ranged</h2>
    <p class='gold'>Right Hand or Both Hands</p>";
    if ($row["arrows"] > 0) {
    ...
    if ($row["woodenbow"] > 0) {
        ...
        if ($row["equipR"] == "wooden bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip wooden bow' /> ";
        }
    ...
    if ($row["hunterbow"] > 0) {
        ...
        if ($row["equipR"] == "hunter bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip hunter bow' /> ";
        }
    ...
    if ($row["longbow"] > 0) {
        ...
        if ($row["equipR"] == "long bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip long bow' /> ";
        }
    ...
    if ($row["crossbow"] > 0) {
        ...
        if ($row["equipR"] == "crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip crossbow' /> ";
        }
    ...
    if ($row["javelin"] > 0) {
        ...
        if ($row["equipR"] == "javelin") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip javelin' /> ";
        }
    ...
    if ($row["ironboomerang"] > 0) {
        ...
        if ($row["equipR"] == "iron boomerang") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron boomerang' /> ";
        }
    ...
    if ($row["harpoon"] > 0) {
        ...
        if ($row["equipR"] == "harpoon") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip harpoon' /> ";
        }
    ...
    if ($row["ironchakram"] > 0) {
        ...
        if ($row["equipR"] == "iron chakram") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron chakram' /> ";
        }
    ...
    if ($row["ironbow"] > 0) {
        ...
        if ($row["equipR"] == "iron bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron bow' /> ";
        }
    ...
    if ($row["enchantedbow"] > 0) {
        ...
        if ($row["equipR"] == "enchanted bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip enchanted bow' /> ";
        }
    ...
    if ($row["jimbow"] > 0) {
        ...
        if ($row["equipR"] == "jim bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip jim bow' /> ";
        }
    ...
    if ($row["ironcrossbow"] > 0) {
        ...
        if ($row["equipR"] == "iron crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron crossbow' /> ";
        }
    ...
    if ($row["handcrossbow"] > 0) {
        ...
        if ($row["equipR"] == "hand crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip hand crossbow' /> ";
        }
    ...
    if ($row["compoundcrossbow"] > 0) {
        ...
        if ($row["equipR"] == "compound crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip compound crossbow' /> ";
        }
    ...
    if ($row["ironjavelin"] > 0) {
        ...
        if ($row["equipR"] == "iron javelin") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron javelin' /> ";
        }
    ...
    if ($row["silverboomerang"] > 0) {
        ...
        if ($row["equipR"] == "silver boomerang") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver boomerang' /> ";
        }
    ...
    if ($row["silverbow"] > 0) {
        ...
        if ($row["equipR"] == "silver bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver bow' /> ";
        }
    ...
    if ($row["silvercrossbow"] > 0) {
        ...
        if ($row["equipR"] == "silver crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver crossbow' /> ";
        }
    ...
    if ($row["steelboomerang"] > 0) {
        ...
        if ($row["equipR"] == "steel boomerang") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel boomerang' /> ";
        }
    ...
    if ($row["steelbow"] > 0) {
        ...
        if ($row["equipR"] == "steel bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel bow' /> ";
        }
    ...
    if ($row["steelcrossbow"] > 0) {
        ...
        if ($row["equipR"] == "steel crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel crossbow' /> ";
        }
    ...
    if ($row["steeljavelin"] > 0) {
        ...
        if ($row["equipR"] == "steel javelin") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel javelin' /> ";
        }
    ...
    if ($row["steelchakram"] > 0) {
        ...
        if ($row["equipR"] == "steel chakram") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel chakram' /> ";
        }
    ...
    if ($row["rangerbow"] > 0) {
        ...
        if ($row["equipR"] == "ranger bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ranger bow' /> ";
        }
    ...
    if ($row["keeperscrossbow"] > 0) {
        ...
        if ($row["equipR"] == "keeper's crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip keepers crossbow' /> ";
        }
    ...
    if ($row["mithrilboomerang"] > 0) {
        ...
        if ($row["equipR"] == "mithril boomerang") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mithril boomerang' /> ";
        }
    ...
    if ($row["mithrilbow"] > 0) {
        ...
        if ($row["equipR"] == "mithril bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mithril bow' /> ";
        }
    ...
    if ($row["mithrilcrossbow"] > 0) {
        ...
        if ($row["equipR"] == "mithril crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mithril crossbow' /> ";
        }
    ...
    if ($row["mithriljavelin"] > 0) {
        echo "<div>";
        if ($row["equipR"] == "mithril javelin") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mithril javelin' /> ";
        }
    ...
    if ($row["mithrilchakram"] > 0) {
        ...
        if ($row["equipR"] == "mithril chakram") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mithril chakram' /> ";
        }
    ...
    if ($row["blackboomerang"] > 0) {
        ...
        if ($row["equipR"] == "black boomerang") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip black boomerang' /> ";
        }
    ...
    if ($row["blackbow"] > 0) {
        ...
        if ($row["equipR"] == "black bow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip black bow' /> ";
        }
    ...
    if ($row["blackcrossbow"] > 0) {
        ...
        if ($row["equipR"] == "black crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip black crossbow' /> ";
        }
    ...
    if ($row["rangercrossbow"] > 0) {
        ...
        if ($row["equipR"] == "ranger crossbow") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ranger crossbow' /> ";
        }
    ...
    if ($row["traininghelmet"] > 0) {
        ...
        if ($row["equipHead"] == "training helmet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip training helmet' /> ";
        }
    ...
    if ($row["basichelmet"] > 0) {
        ...
        if ($row["equipHead"] == "basic helmet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip basic helmet' /> ";
        }
    ...
    if ($row["basichood"] > 0) {
        ...
        if ($row["equipHead"] == "basic hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip basic hood' /> ";
        }
    ...
    if ($row["redhood"] > 0) {
        ...
        if ($row["equipHead"] == "red hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip red hood' /> ";
        }
    ...
    if ($row["greenhood"] > 0) {
        ...
        if ($row["equipHead"] == "green hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip green hood' /> ";
        }
    ...
    if ($row["bluehood"] > 0) {
        ...
        if ($row["equipHead"] == "blue hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip blue hood' /> ";
        }
    ...
    if ($row["leatherhood"] > 0) {
        ...
        if ($row["equipHead"] == "leather hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip leather hood' /> ";
        }
    ...
    if ($row["leatherhelmet"] > 0) {
        ...
        if ($row["equipHead"] == "leather helmet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip leather helmet' /> ";
        }
    ...
    if ($row["hornedhelmet"] > 0) {
        ...
        if ($row["equipHead"] == "horned helmet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip horned helmet' /> ";
        }
    ...
    if ($row["barbarianhelmet"] > 0) {
        ...
        if ($row["equipHead"] == "barbarian helmet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip barbarian helmet' /> ";
        }
    ...
    if ($row["grayhood"] > 0) {
        ...
        if ($row["equipHead"] == "gray hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip gray hood' /> ";
        }
    ...
    if ($row["wizardhat"] > 0) {
        ...
        if ($row["equipHead"] == "wizard hat") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip wizard hat' /> ";
        }
    ...
    if ($row["battlehelm"] > 0) {
        ...
        if ($row["equipHead"] == "battle helm") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip battle helm' /> ";
        }
    ...
    if ($row["victoriashood"] > 0) {
        ...
        if ($row["equipHead"] == "victoria's hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip victorias hood' /> ";
        }
    ...
    if ($row["scorpionhood"] > 0) {
        ...
        if ($row["equipHead"] == "scorpion hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip scorpion hood' /> ";
        }
    ...
    if ($row["ironhood"] > 0) {
        ...
        if ($row["equipHead"] == "iron hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron hood' /> ";
        }
    ...
    if ($row["ironhelmet"] > 0) {
        ...
        if ($row["equipHead"] == "iron helmet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron helmet' /> ";
        }
    ...
    if ($row["hauntedhelm"] > 0) {
        ...
        if ($row["equipHead"] == "haunted helm") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip haunted helm' /> ";
        }
    ...
    if ($row["bandithood"] > 0) {
        ...
        if ($row["equipHead"] == "bandit hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bandit hood' /> ";
        }
    ...
    if ($row["calamaricap"] > 0) {
        ...
        if ($row["equipHead"] == "calamari cap") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip calamari cap' /> ";
        }
    ...
    if ($row["heavyhelmet"] > 0) {
        ...
        if ($row["equipHead"] == "heavy helmet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip heavy helmet' /> ";
        }
    ...
    if ($row["kettlehelm"] > 0) {
        ...
        if ($row["equipHead"] == "kettle helm") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip kettle helm' /> ";
        }
    ...
    if ($row["perfecthelmet"] > 0) {
        ...
        if ($row["equipHead"] == "perfect helmet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip perfect helmet' /> ";
        }
    ...
    if ($row["silverhelmet"] > 0) {
        ...
        if ($row["equipHead"] == "silver helmet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver helmet' /> ";
        }
    ...
    if ($row["trollcrown"] > 0) {
        ...
        if ($row["equipHead"] == "troll crown") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip troll crown' /> ";
        }
    ...
    if ($row["rangerhood"] > 0) {
        ...
        if ($row["equipHead"] == "ranger hood") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ranger hood' /> ";
        }
    ...
    if ($row["trainingarmor"] > 0) {
        ...
        if ($row["equipBody"] == "training armor") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip training armor' /> ";
        }
    ...
    if ($row["trainingarmorpro"] > 0) {
        ...
        if ($row["equipBody"] == "training armor pro") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip training armor pro' /> ";
        }
    ...
    if ($row["paddedarmor"] > 0) {
        ...
        if ($row["equipBody"] == "padded armor") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip padded armor' /> ";
        }
    ...
    if ($row["pajamas"] > 0) {
        ...
        if ($row["equipBody"] == "pajamas") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip pajamas' /> ";
        }
    ...
    if ($row["greencloak"] > 0) {
        ...
        if ($row["equipBody"] == "green cloak") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip green cloak' /> ";
        }
    ...
    if ($row["blackrobe"] > 0) {
        ...
        if ($row["equipBody"] == "black robe") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip black robe' /> ";
        }
    ...
    if ($row["grayrobe"] > 0) {
        ...
        if ($row["equipBody"] == "gray robe") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip gray robe' /> ";
        }
    ...
    if ($row["leathervest"] > 0) {
        ...
        if ($row["equipBody"] == "leather vest") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip leather vest' /> ";
        }
    ...
    if ($row["leatherarmor"] > 0) {
        ...
        if ($row["equipBody"] == "leather armor") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip leather armor' /> ";
        }
    ...
    if ($row["sasquatchcloak"] > 0) {
        ...
        if ($row["equipBody"] == "sasquatch cloak") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip sasquatch cloak' /> ";
        }
    ...
    if ($row["turtleshell"] > 0) {
        ...
        if ($row["equipBody"] == "turtle shell") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip turtle shell' /> ";
        }
    ...
    if ($row["ironarmor"] > 0) {
        ...
        if ($row["equipBody"] == "iron armor") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron armor' /> ";
        }
    ...
    if ($row["ironcape"] > 0) {
        ...
        if ($row["equipBody"] == "iron cape") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron cape' /> ";
        }
    ...
    if ($row["blackcape"] > 0) {
        ...
        if ($row["equipBody"] == "black cape") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip black cape' /> ";
        }
    ...
    if ($row["forestcloak"] > 0) {
        ...
        if ($row["equipBody"] == "forest cloak") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip forest cloak' /> ";
        }
    ...
    if ($row["warlockrobe"] > 0) {
        ...
        if ($row["equipBody"] == "warlock robe") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip warlock robe' /> ";
        }
    ...
    if ($row["championarmor"] > 0) {
        ...
        if ($row["equipBody"] == "champion armor") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip champion armor' /> ";
        }
    ...
    if ($row["perfectarmor"] > 0) {
        echo "<div>";
        if ($row["equipBody"] == "perfect armor") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip perfect armor' /> ";
        }
    ...
    if ($row["silverbreastplate"] > 0) {
        ...
        if ($row["equipBody"] == "silver breastplate") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver breastplate' /> ";
        }
    ...
    if ($row["steelarmor"] > 0) {
        ...
        if ($row["equipBody"] == "steel armor") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel armor' /> ";
        }
    ...
    if ($row["steelcape"] > 0) {
        ...
        if ($row["equipBody"] == "steel cape") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel cape' /> ";
        }
    ...
    if ($row["rangercloak"] > 0) {
        ...
        if ($row["equipBody"] == "ranger cloak") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ranger cloak' /> ";
        }
    ...
    if ($row["yeticloak"] > 0) {
        ...
        if ($row["equipBody"] == "yeti cloak") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip yeti cloak' /> ";
        }
    ...
    if ($row["demoncape"] > 0) {
        ...
        if ($row["equipBody"] == "demon cape") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip demon cape' /> ";
        }
    ...
    if ($row["silverpajamas"] > 0) {
        ...
        if ($row["equipBody"] == "silver pajamas") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver pajamas' /> ";
        }
    ...
    if ($row["traininggloves"] > 0) {
        ...
        if ($row["equipHands"] == "training gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip training gloves' /> ";
        }
    ...
    if ($row["wristbracers"] > 0) {
        ...
        if ($row["equipHands"] == "wrist bracers") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip wrist bracers' /> ";
        }
    ...
    if ($row["glowingbrace"] > 0) {
        ...
        if ($row["equipHands"] == "glowing brace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip glowing brace' /> ";
        }
    ...
    if ($row["blackgloves"] > 0) {
        ...
        if ($row["equipHands"] == "black gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip black gloves' /> ";
        }
    ...
    if ($row["greengloves"] > 0) {
        ...
        if ($row["equipHands"] == "green gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip green gloves' /> ";
        }
    ...
    if ($row["graygloves"] > 0) {
        ...
        if ($row["equipHands"] == "gray gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip gray gloves' /> ";
        }
    ...
    if ($row["leathergloves"] > 0) {
        ...
        if ($row["equipHands"] == "leather gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip leather gloves' /> ";
        }
    ...
    if ($row["huntergloves"] > 0) {
        ...
        if ($row["equipHands"] == "hunter gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip hunter gloves' /> ";
        }
    ...
    if ($row["trollgloves"] > 0) {
        ...
        if ($row["equipHands"] == "troll gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip troll gloves' /> ";
        }
    ...
    if ($row["irongauntlets"] > 0) {
        ...
        if ($row["equipHands"] == "iron gauntlets") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron gauntlets' /> ";
        }
    ...
    if ($row["irongloves"] > 0) {
        ...
        if ($row["equipHands"] == "iron gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron gloves' /> ";
        }
    ...
    if ($row["ironknuckles"] > 0) {
        ...
        if ($row["equipHands"] == "iron knuckles") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron knuckles' /> ";
        }
    ...
    if ($row["banditgloves"] > 0) {
        ...
        if ($row["equipHands"] == "bandit gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bandit gloves' /> ";
        }
    ...
    if ($row["gatorgloves"] > 0) {
        ...
        if ($row["equipHands"] == "gator gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip gator gloves' /> ";
        }
    ...
    if ($row["grottogloves"] > 0) {
        ...
        if ($row["equipHands"] == "grotto gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip grotto gloves' /> ";
        }
    ...
    if ($row["perfectgloves"] > 0) {
        echo "<div>";
        if ($row["equipHands"] == "perfect gloves") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip perfect gloves' /> ";
        }
    ...
    if ($row["silvergauntlets"] > 0) {
        ...
        if ($row["equipHands"] == "silver gauntlets") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver gauntlets' /> ";
        }
    ...
    if ($row["steelgauntlets"] > 0) {
        ...
        if ($row["equipHands"] == "steel gauntlets") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel gauntlets' /> ";
        }
    ...
    if ($row["steelgloves"] > 0) {
        ...
        if ($row["equipHands"] == "steel gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel gloves' /> ";
        }
    ...
    if ($row["silkbracers"] > 0) {
        ...
        if ($row["equipHands"] == "silk bracers") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silk bracers' /> ";
        }
    ...
    if ($row["rangergloves"] > 0) {
        ...
        if ($row["equipHands"] == "ranger gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ranger gloves' /> ";
        }
    ...
    if ($row["glowinggloves"] > 0) {
        ...
        if ($row["equipHands"] == "glowing gloves") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip glowing gloves' /> ";
        }
        echo "<span>".$row["glowinggloves"]."x </span> <span class='lightblue'> glowing </span> gloves <span>( <i class='blue'>+10</i> mag )</span>
      <span class='sellPrice'>".$_SESSION['COSTglowinggloves']."</span>
      <input type='submit' class='sellBtn' name='input1' value='sell glowing gloves' /> </div>";
    }
    echo '-';
    ...
    if ($row["trainingboots"] > 0) {
        ...
        if ($row["equipFeet"] == "training boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip training boots' /> ";
        }
    ...
    if ($row["redboots"] > 0) {
        ...
        if ($row["equipFeet"] == "red boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip red boots' /> ";
        }
    ...
    if ($row["greenboots"] > 0) {
        ...
        if ($row["equipFeet"] == "green boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip green boots' /> ";
        }
    ...
    if ($row["blackboots"] > 0) {
        ...
        if ($row["equipFeet"] == "black boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip black boots' /> ";
        }
    ...
    if ($row["grayboots"] > 0) {
        ...
        if ($row["equipFeet"] == "gray boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip gray boots' /> ";
        }
    ...
    if ($row["slippers"] > 0) {
        ...
        if ($row["equipFeet"] == "slippers") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip slippers' /> ";
        }
    ...
    if ($row["leatherboots"] > 0) {
        ...
        if ($row["equipFeet"] == "leather boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip leather boots' /> ";
        }
    ...
    if ($row["trollboots"] > 0) {
        ...
        if ($row["equipFeet"] == "troll boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip troll boots' /> ";
        }
    ...
    if ($row["boneboots"] > 0) {
        ...
        if ($row["equipFeet"] == "bone boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bone boots' /> ";
        }
    ...
    if ($row["ironboots"] > 0) {
        ...
        if ($row["equipFeet"] == "iron boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron boots' /> ";
        }
    ...
    if ($row["bigfootboots"] > 0) {
        ...
        if ($row["equipFeet"] == "bigfoot boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bigfoot boots' /> ";
        }
    ...
    if ($row["banditboots"] > 0) {
        ...
        if ($row["equipFeet"] == "bandit boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bandit boots' /> ";
        }
    ...
    if ($row["mudboots"] > 0) {
        ...
        if ($row["equipFeet"] == "mud boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip mud boots' /> ";
        }
    ...
    if ($row["warlockboots"] > 0) {
        ...
        if ($row["equipFeet"] == "warlock boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip warlock boots' /> ";
        }
    ...
    if ($row["perfectboots"] > 0) {
        echo "<div>";
        if ($row["equipFeet"] == "perfect boots") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip perfect boots' /> ";
        }
    ...
    if ($row["silverboots"] > 0) {
        ...
        if ($row["equipFeet"] == "silver boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver boots' /> ";
        }
    ...
    if ($row["steelboots"] > 0) {
        ...
        if ($row["equipFeet"] == "steel boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel boots' /> ";
        }
    ...
    if ($row["thunderboots"] > 0) {
        ...
        if ($row["equipFeet"] == "thunder boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip thunder boots' /> ";
        }
    ...
    if ($row["rangerboots"] > 0) {
        ...
        if ($row["equipFeet"] == "ranger boots") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ranger boots' /> ";
        }
    ...
    if ($row["silverslippers"] > 0) {
        ...
        if ($row["equipFeet"] == "silver slippers") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver slippers' /> ";
        }
    ...
    if ($row["ringofstrength"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of strength") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength' /> ";
        }
    ...
    if ($row["ringofdexterity"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of dexterity") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity' /> ";
        }
    ...
    if ($row["ringofmagic"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of magic") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic' /> ";
        }
    ...
    if ($row["ringofdefense"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of defense") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense' /> ";
        }
    ...
    if ($row["ringofstrengthII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of strength II") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength II' /> ";
        }
    ...
    if ($row["ringofdexterityII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of dexterity II") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity II' /> ";
        }
    ...
    if ($row["ringofmagicII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of magic II") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic II' /> ";
        }
    ...
    if ($row["ringofdefenseII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of defense II") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense II' /> ";
        }
    ...
    if ($row["ringofstrengthIII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of strength III") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength III' /> ";
        }
    ...
    if ($row["ringofdexterityIII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of dexterity III") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity III' /> ";
        }
    ...
    if ($row["ringofmagicIII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of magic III") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic III' /> ";
        }
    ...
    if ($row["ringofdefenseIII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of defense III") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense III' /> ";
        }
    ...
    if ($row["ringofstrengthIV"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of strength IV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength IV' /> ";
        }
    ...
    if ($row["ringofdexterityIV"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of dexterity IV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity IV' /> ";
        }
    ...
    if ($row["ringofmagicIV"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of magic IV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic IV' /> ";
        }
    ...
    if ($row["ringofdefenseIV"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of defense IV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense IV' /> ";
        }
    ...
    if ($row["ringofstrengthV"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of strength V") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength V' /> ";
        }
    ...
    if ($row["ringofdexterityV"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of dexterity V") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity V' /> ";
        }
    ...
    if ($row["ringofmagicV"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of magic V") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic V' /> ";
        }
    ...
    if ($row["ringofdefenseV"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of defense V") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense V' /> ";
        }
    ...
    if ($row["soldiersring"] > 0) {
        ...
        if ($row["equipRing1"] == "soldier's ring") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip soldiers ring' /> ";
        }
    ...
    if ($row["hunterring"] > 0) {
        ...
        if ($row["equipRing1"] == "hunter ring") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip hunter ring' /> ";
        }
    ...
    if ($row["coyotering"] > 0) {
        ...
        if ($row["equipRing1"] == "coyote ring") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip coyote ring' /> ";
        }
    ...
    if ($row["redwizardring"] > 0) {
        ...
        if ($row["equipRing1"] == "red wizard ring") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip red wizard ring' /> ";
        }
    ...
    if ($row["greenwizardring"] > 0) {
        ...
        if ($row["equipRing1"] == "green wizard ring") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip green wizard ring' /> ";
        }
    ...
    if ($row["yellowwizardring"] > 0) {
        ...
        if ($row["equipRing1"] == "yellow wizard ring") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip yellow wizard ring' /> ";
        }
    ...
    if ($row["silverring"] > 0) {
        ...
        if ($row["equipRing1"] == "silver ring") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver ring' /> ";
        }
    ...
    if ($row["ringofstrengthVI"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of strength VI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength VI' /> ";
        }
    ...
    if ($row["ringofdexterityVI"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of dexterity VI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity VI' /> ";
        }
    ...
    if ($row["ringofmagicVI"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of magic VI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic VI' /> ";
        }
    ...
    if ($row["ringofdefenseVI"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of defense VI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense VI' /> ";
        }
    ...
    if ($row["ringofstrengthVII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of strength VII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength VII' /> ";
        }
    ...
    if ($row["ringofdexterityVII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of dexterity VII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity VII' /> ";
        }
    ...
    if ($row["ringofmagicVII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of magic VII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic VII' /> ";
        }
    ...
    if ($row["ringofdefenseVII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of defense VII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense VII' /> ";
        }
    ...
    if ($row["ringofstrengthVIII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of strength VIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength VIII' /> ";
        }
    ...
    if ($row["ringofdexterityVIII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of dexterity VIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity VIII' /> ";
        }
    ...
    if ($row["ringofmagicVIII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of magic VIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic VIII' /> ";
        }
    ...
    if ($row["ringofdefenseVIII"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of defense VIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense VIII' /> ";
        }
    ...
    if ($row["ringofstrengthIX"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of strength IX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength IX' /> ";
        }
    ...
    if ($row["ringofdexterityIX"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of dexterity IX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity IX' /> ";
        }
    ...
    if ($row["ringofmagicIX"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of magic IX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic IX' /> ";
        }
    ...
    if ($row["ringofdefenseIX"] > 0) {
        ...
        if ($row["equipRing1"] == "ring of defense IX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense IX' /> ";
        }
    ...
    if ($row["ringofstrengthX"] > 0) {
        echo "<div>";
        if ($row["equipRing1"] == "ring of strength X") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of strength X' /> ";
        }
        echo "<span>".$row["ringofstrengthX"]."x </span> ring of strength X <span>( <i class='lightred'>+10</i> str )</span> </div>";
    }
    if ($row["ringofdexterityX"] > 0) {
        echo "<div>";
        if ($row["equipRing1"] == "ring of dexterity X") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of dexterity X' /> ";
        }
        echo "<span>".$row["ringofdexterityX"]."x </span> ring of dexterity X  <span>( <i class='green'>+10</i> dex )</span> </div>";
    }
    if ($row["ringofmagicX"] > 0) {
        echo "<div>";
        if ($row["equipRing1"] == "ring of magic X") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of magic X' /> ";
        }
        echo "<span>".$row["ringofmagicX"]."x </span> ring of magic X  <span>( <i class='blue'>+10</i> mag )</span> </div>";
    }
    if ($row["ringofdefenseX"] > 0) {
        echo "<div>";
        if ($row["equipRing1"] == "ring of defense X") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of defense X' /> ";
        }
    ...
    if ($row["ringofhealthregen"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen' /> ";
        }
    ...
    if ($row["ringofmanaregen"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen' /> ";
        }
    ...
    if ($row["ringofhealthregenII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen II") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen II' /> ";
        }
    ...
    if ($row["ringofmanaregenII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen II") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen II' /> ";
        }
    ...
    if ($row["ringofhealthregenIII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen III") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen III' /> ";
        }
    ...
    if ($row["ringofmanaregenIII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen III") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen III' /> ";
        }
    ...
    if ($row["ringofhealthregenIV"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen IV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen IV' /> ";
        }
    ...
    if ($row["ringofmanaregenIV"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen IV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen IV' /> ";
        }
    ...
    if ($row["ringofhealthregenV"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen V") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen V' /> ";
        }
    ...
    if ($row["ringofmanaregenV"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen V") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen V' /> ";
        }
    ...
    if ($row["ringofhealthregenVI"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen VI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen VI' /> ";
        }
    ...
    if ($row["ringofmanaregenVI"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen VI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen VI' /> ";
        }
    ...
    if ($row["ringofhealthregenVII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen VII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen VII' /> ";
        }
    ...
    if ($row["ringofmanaregenVII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen VII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen VII' /> ";
        }
    ...
    if ($row["ringofhealthregenVIII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen VIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen VIII' /> ";
        }
    ...
    if ($row["ringofmanaregenVIII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen VIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen VIII' /> ";
        }
    ...
    if ($row["ringofhealthregenIX"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen IX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen IX' /> ";
        }
    ...
    if ($row["ringofmanaregenIX"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen IX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen IX' /> ";
        }
    ...
    if ($row["ringofhealthregenX"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen X") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen X' /> ";
        }
    ...
    if ($row["ringofmanaregenX"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen X") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen X' /> ";
        }
    ...
    if ($row["ringofhealthregenXI"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XI' /> ";
        }
    ...
    if ($row["ringofmanaregenXI"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XI' /> ";
        }
    ...
    if ($row["ringofhealthregenXII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XII' /> ";
        }
    ...
    if ($row["ringofmanaregenXII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XII' /> ";
        }
    ...
    if ($row["ringofhealthregenXIII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XIII' /> ";
        }
    ...
    if ($row["ringofmanaregenXIII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XIII' /> ";
        }
    ...
    if ($row["ringofhealthregenXIV"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XIV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XIV' /> ";
        }
    ...
    if ($row["ringofmanaregenXIV"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XIV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XIV' /> ";
        }
    ...
    if ($row["ringofhealthregenXV"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XV' /> ";
        }
    ...
    if ($row["ringofmanaregenXV"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XV") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XV' /> ";
        }
    ...
    if ($row["ringofhealthregenXVI"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XVI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XVI' /> ";
        }
    ...
    if ($row["ringofmanaregenXVI"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XVI") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XVI' /> ";
        }
    ...
    if ($row["ringofhealthregenXVII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XVII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XVII' /> ";
        }
    ...
    if ($row["ringofmanaregenXVII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XVII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XVII' /> ";
        }
    ...
    if ($row["ringofhealthregenXVIII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XVIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XVIII' /> ";
        }
    ...
    if ($row["ringofmanaregenXVIII"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XVIII") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XVIII' /> ";
        }
    ...
    if ($row["ringofhealthregenXIX"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XIX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XIX' /> ";
        }
    ...
    if ($row["ringofmanaregenXIX"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XIX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XIX' /> ";
        }
    ...
    if ($row["ringofhealthregenXX"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of health regen XX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of health regen XX' /> ";
        }
    ...
    if ($row["ringofmanaregenXX"] > 0) {
        ...
        if ($row["equipRing2"] == "ring of mana regen XX") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ring of mana regen XX' /> ";
        }
    ...
    if ($row["woodennecklace"] > 0) {
        ...
        if ($row["equipNeck"] == "wooden necklace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip wooden necklace' /> ";
        }
    ...
    if ($row["bonenecklace"] > 0) {
        ...
        if ($row["equipNeck"] == "bone necklace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip bone necklace' /> ";
        }
    ...
    if ($row["stonenecklace"] > 0) {
        ...
        if ($row["equipNeck"] == "stone necklace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip stone necklace' /> ";
        }
    ...
    if ($row["bluependant"] > 0) {
        ...
        if ($row["equipNeck"] == "blue pendant") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip blue pendant' /> ";
        }
    ...
    if ($row["redtalisman"] > 0) {
        ...
        if ($row["equipNeck"] == "red talisman") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip red talisman' /> ";
        }
    ...
    if ($row["greenpendant"] > 0) {
        ...
        if ($row["equipNeck"] == "green pendant") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip green pendant' /> ";
        }
    ...
    if ($row["coralnecklace"] > 0) {
        ...
        if ($row["equipNeck"] == "coral necklace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip coral necklace' /> ";
        }
    ...
    if ($row["vapornecklace"] > 0) {
        ...
        if ($row["equipNeck"] == "vapor necklace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip vapor necklace' /> ";
        }
    ...
    if ($row["silvernecklace"] > 0) {
        ...
        if ($row["equipNeck"] == "silver necklace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip silver necklace' /> ";
        }
    ...
    if ($row["ironnecklace"] > 0) {
        ...
        if ($row["equipNeck"] == "iron necklace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip iron necklace' /> ";
        }
    ...
    if ($row["shamannecklace"] > 0) {
        ...
        if ($row["equipNeck"] == "shaman necklace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip shaman necklace' /> ";
        }
    ...
    if ($row["warriorpendant"] > 0) {
        ...
        if ($row["equipNeck"] == "warrior pendant") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip warrior pendant' /> ";
        }
    ...
    if ($row["rangeramulet"] > 0) {
        ...
        if ($row["equipNeck"] == "ranger amulet") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip ranger amulet' /> ";
        }
    ...
    if ($row["steelnecklace"] > 0) {
        ...
        if ($row["equipNeck"] == "steel necklace") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip steel necklace' /> ";
        }
    ...
    if ($row["coralcoin"] > 0) {
        ...
        if ($row["equipArtifact"] == "coral coin") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip coral coin' /> ";
        }
    ...
    if ($row["squidtooth"] > 0) {
        ...
        if ($row["equipArtifact"] == "squid tooth") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip squid tooth' /> ";
        }
    ...
    if ($row["pearlofwisdom"] > 0) {
        ...
        if ($row["equipArtifact"] == "pearl of wisdom") {
            ...
            echo "<input type='submit' class='equipBtn' name='input1' value='equip pearl of wisdom' /> ";
        }
    ...
    if ($row["COMPdwarfaxeman"] > 0) {
        ...
        if ($row["equipComp"] == "dwarf axeman") {
            ...
            echo "<input type='submit' class='activateBtn' name='input1' value='activate dwarf axeman' />";
        }
    ...
    if ($row["COMPelfranger"] > 0) {
        ...
        if ($row["equipComp"] == "elf ranger") {
            ...
            echo "<input type='submit' class='activateBtn' name='input1' value='activate elf ranger' />";
        }
    ...
    if ($row["pethampster"] > 0) {
        ...
        if ($row["equipPet"] == "pet hampster") {
            ...
            echo "<input type='submit' class='activateBtn' name='input1' value='activate pet hampster' /> ";
        }
    ...
    if ($row["petbat"] > 0) {
        ...
        if ($row["equipPet"] == "pet bat") {
            ...
            echo "<input type='submit' class='activateBtn' name='input1' value='activate pet bat' /> ";
        }
    ...
    if ($row["MOUNTwoodenboat"] > 0) {
        ...
        if ($row["equipMount"] == "wooden boat") {
            ...
            echo "<input type='submit' class='eatBtn' name='input1' value='use wooden boat' />";
        }
    ...
    if ($row["MOUNTironboat"] > 0) {
        ...
        if ($row["equipMount"] == "iron boat") {
            ...
            echo "<input type='submit' class='eatBtn' name='input1' value='use iron boat' />";
        }
        echo " <span>".$row["MOUNTironboat"]."x </span> <span class='lightbrown'>iron </span> boat <span> ( <i class='gold'>+50</i> def )</span></div>";
    }
    ...
    if ($row["MOUNTsteelboat"] > 0) {
        ...
        if ($row["equipMount"] == "steel boat") {
            ...
            echo "<input type='submit' class='eatBtn' name='input1' value='use steel boat' />";
        }
        echo " <span>".$row["MOUNTsteelboat"]."x </span> <span class='gray'>steel </span> boat <span> ( <i class='gold'>+100</i> def )</span></div>";
    }
    ...
    if ($row["MOUNTmithrilboat"] > 0) {
        ...
        if ($row["equipMount"] == "mithril boat") {
            ...
            echo "<input type='submit' class='eatBtn' name='input1' value='use mithril boat' />";
        }
        echo " <span>".$row["MOUNTmithrilboat"]."x </span> <span class='blue'>mithril </span> boat <span> ( <i class='gold'>+200</i> def )</span></div>";
    }
    ...
    if ($row["MOUNTdirewolf"] > 0) {
        ...
        if ($row["equipMount"] == "dire wolf") {
            ...
            echo "<input type='submit' class='mountBtn' name='input1' value='mount dire wolf' />";
        }
        echo " <span>".$row["MOUNTdirewolf"]."x </span> <span class='lightred'>dire</span> wolf <span> ( <i class='lightred'>+50</i> str, <i class='gold'>+50</i> def )</span></div>";
    }

    if ($row["MOUNTbluefalcon"] > 0) {
        echo "<div>";
        if ($row["equipMount"] == "blue falcon") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<input type='submit' class='mountBtn' name='input1' value='mount blue falcon' />";
        }
    ...
    if ($row["MOUNTgreengriffin"] > 0) {
        if ($row["equipMount"] == "direwolf") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<div><input type='submit' class='equipBtn' name='input1' value='mount dire wolf' />";
        }
    ...
    if ($row["AURAshamansblessing"] > 0) {
        if ($row["equipAura"] == "shaman's blessing") {
            echo "<span class='equipped'>active</span> ";
        } else {
            echo "<div><input type='submit' class='activateBtn' name='input1' value='activate shamans blessing' />";
        }
    ...
    if ($row["AURAstoneaura"] > 0) {
        if ($row["equipAura"] == "stone aura") {
            ...
            echo "<div><input type='submit' class='activateBtn' name='input1' value='activate stone aura' />";
        }
    ...
    if ($row["AURAsilveraura"] > 0) {
        if ($row["equipAura"] == "silver aura") {
            ...
            echo "<div><input type='submit' class='activateBtn' name='input1' value='activate silver aura' />";
        }
    ...
    if ($row["coffee"] > 0) {
		...
		<span>".$row["coffee"]."x </span> <span class='lightbrown'>coffee</span> <span>( <i class='cyan'>+5</i> all stats / 100 clicks )</span></div>";
    }
    if ($row["tea"] > 0) {
