<?php					
								$roomname = "Mine Level 9";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['descm09'];
...
{			echo 'You travel up the mine<br/>';
   	$message="<i class='lightblueBG'>You travel up the mine</i></br>".$_SESSION['descm08'];
	include ('update_feed.php'); // --- update feed
...
{		
		if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
			...
			echo 'You dig down to mine level 10, the Lair of the Phoenix!<br/>';
   			$message="<i class='lightblueBG'>You dig down to mine level 10, the Lair of the Phoenix</i></br>".$_SESSION['descm10'];
			include ('update_feed.php'); // --- update feed
