...
{	if ($polearm >= 1)
	 	...
	 	{ echo $message="<div class='menuAction'><i class='fa fa-arrow-circle-up'></i>You grab a polearm and put in your pack! [ +1 polearm ]</div>"; include ('update_feed.php'); // --- update feed
