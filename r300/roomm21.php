<?php					
								$roomname = "Mine Level 21";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['descm21'];
...
// include ('battle-sets/mine21.php');	// ENEMY BATTLE - MINE LEVEL 1-4
...
{			echo 'You travel up the mine<br/>';
   	$message="<i class='lightblueBG'>You travel up the mine</i></br>".$_SESSION['descm20'];
	include ('update_feed.php'); // --- update feed
...
{		
		if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
			...
			echo 'You dig down to mine level 22.<br/>';
   			$message="<i class='lightblueBG'>You dig down to mine level 22.</i></br>".$_SESSION['descm22'];
			include ('update_feed.php'); // --- update feed
