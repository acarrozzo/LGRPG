26<?php
                                $roomname = "Mine Level 26";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['descm26'];
...
while ($row = $result->fetch_assoc()) {
    ...
    elseif ($input=='u' || $input=='up') {
        ...
        $message="<i class='lightblueBG'>You travel up the mine</i></br>".$_SESSION['descm25'];
        include('update_feed.php'); // --- update feed
        ...
        if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
            ...
            echo 'You dig down to mine level 27.<br/>';
            $message="<i class='lightblueBG'>You dig down to mine level 27.</i></br>".$_SESSION['descm27'];
            include('update_feed.php'); // --- update feed
