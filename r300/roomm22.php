<?php					
								$roomname = "Mine Level 22";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['descm22'];
...
{			echo 'You travel up the mine<br/>';
   	$message="<i class='lightblueBG'>You travel up the mine</i></br>".$_SESSION['descm21'];
	include ('update_feed.php'); // --- update feed
...
{		
		if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
			...
			echo 'You dig down to mine level 23.<br/>';
   			$message="<i class='lightblueBG'>You dig down to mine level 22.</i></br>".$_SESSION['descm23'];
			include ('update_feed.php'); // --- update feed
