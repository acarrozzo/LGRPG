<?php					
								$roomname = "Mine Level 18";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['descm18'];
...
{			echo 'You travel up the mine<br/>';
   	$message="<i class='lightblueBG'>You travel up the mine</i></br>".$_SESSION['descm17'];
	include ('update_feed.php'); // --- update feed
...
{		
		if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
			...
			echo 'You dig down to mine level 19.<br/>';
   			$message="<i class='lightblueBG'>You dig down to mine level 19.</i></br>".$_SESSION['descm19'];
			include ('update_feed.php'); // --- update feed
