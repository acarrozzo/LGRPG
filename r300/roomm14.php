<?php					
								$roomname = "Mine Level 14";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['descm14'];
...
{			echo 'You travel up the mine<br/>';
   	$message="<i class='lightblueBG'>You travel up the mine</i></br>".$_SESSION['descm13'];
	include ('update_feed.php'); // --- update feed
...
{		
		if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
			...
			echo 'You dig down to mine level 15.<br/>';
   			$message="<i class='lightblueBG'>You dig down to mine level 15.</i></br>".$_SESSION['descm15'];
			include ('update_feed.php'); // --- update feed
