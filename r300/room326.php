<?php
						$roomname = "Red Beard's War Room";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc326'];
...
if(($rand <= 4 ) && $infight==0 && $endfight==0) 
	{	$results = $link->query("UPDATE $user SET enemy = 'Red Beard'"); include ('battle.php'); }		
// -------------------------------------------------------------------------- IN BATTLE		
...
{			echo 'You travel south<br/>';
   	$message="<i>You travel south</i></br>".$_SESSION['desc324'];
	include ('update_feed.php'); // --- update feed
