...
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['descm27'];
...
while ($row = $result->fetch_assoc()) {
    ...
    elseif ($input=='u' || $input=='up') {
        ...
        $message="<i class='lightblueBG'>You travel up the mine</i></br>".$_SESSION['descm26'];
        include('update_feed.php'); // --- update feed
        ...
        if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
            ...
            $message="<i class='lightblueBG'>You dig down to mine level 28.</i></br>".$_SESSION['descm28'];
            include('update_feed.php'); // --- update feed
