...
else if($input=='grand quest 1') 
{
	...
	else if ($grandquest1 == 2) {	
		echo $message="You already completed Grand Quest 1) Grassy Field Savior</br>";
		include ('update_feed.php'); // --- update feed
   	 }   
	else if ($grandquest1 == 1 && ($quest1==2 && $quest2==2 && $quest3==2 && $quest4==2 && $quest5==2 && $quest6==2 && $quest7==2 && $quest8==2 && $quest9==2 && $quest10==2 )) {
