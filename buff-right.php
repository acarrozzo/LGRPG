...
if ($row["equipR"] =="stiletto") {
    echo " <span>( <i class='red'>+1</i>, <i class='blue'>+1</i> )</span>";
    $results = $link->query("UPDATE $user SET strmod = strmod +1");
...
if ($row["equipR"] =="short swordXXX") {
    echo " <span>( <i class='cyan px14'>+lvl*2 </i><i class='red'>+$foreverswordsamage</i> )</span>";
...
if ($row["equipR"] =="flail") {
    echo " <span>( <i class='red'>+7</i>, <i class='gold'>+3</i> )</span>";
...
if ($row["equipR"] =="morning star") {
    echo " <span>( <i class='red'>+7</i>, <i class='blue'>+3</i> )</span>";
    $results = $link->query("UPDATE $user SET strmod = strmod +7");
...
if ($row["equipR"] =="three-chained flail") {
    echo " <span>( <i class='red'>+9</i>, <i class='gold'>+9</i> )</span>";
    $results = $link->query("UPDATE $user SET strmod = strmod +9");
...
if ($row["equipR"] =="poison saber") {
    echo " <span>( <i class='red'>+18</i>, <i class='blue'>+3</i>, <i class='green px10'>poison<i class='px12'>5</i></i> )</span>";
    $results = $link->query("UPDATE $user SET magmod = magmod +3");
    $results = $link->query("UPDATE $user SET strmod = strmod +18");
}
// ----------------------------------------------------------------- war axe
if ($row["equipR"] =="war axe") {
    echo " <span>( <i class='red'>+30</i>, <i class='black'>-5 mag</i> )</span>";
...
if ($row["equipR"] =="battle axe") {
    echo " <span>( <i class='red'>+10</i>, <i class='black'>-2 def</i>  )</span>";
    $results = $link->query("UPDATE $user SET strmod = strmod +10");
    $results = $link->query("UPDATE $user SET defmod = defmod -2");
}
// -----------------------------------------------------------------warhammer buff +12 STR -5 DEF
if ($row["equipR"] =="warhammer") {
    echo " <span>( <i class='red'>+12</i>, <i class='black'>-5 def</i> )</span>";
...
if ($row["equipR"] =="wooden bo") {
    echo " <span>( <i class='red'>+9</i>, <i class='blue'>+1</i> )</span>";
    $results = $link->query("UPDATE $user SET strmod = strmod +9");
    $results = $link->query("UPDATE $user SET magmod = magmod +1");
}
// -----------------------------------------------------------------pike buff +11 STR
...
if ($row["equipR"] =="brass knuckles") {
    echo " <span>( <i class='red'>+16</i>, <i class='blue'>+3</i> )</span>";
...
if ($row["equipR"] =="bone cudgel") {
    echo " <span>( <i class='red'>+32</i>, <i class='black'>-10 mag</i>, <i class='black'>-10 def</i> )</span>";
...
if ($row["equipR"] =="hammerhead hammer") {
    echo " <span>( <i class='red'>+35</i>, <i class='blue'>+10</i>, <i class='gold'>+10</i> )</span>";
...
// -----------------------------------------------------------------riot shield
if ($row["equipR"] =="riot shield") {
    echo " <span>( +300 def, -300 str, dex, mag )</span>";
...
if ($row["equipR"] =="perfect 2h sword") {
    echo " <span>( <i class='cyan'>+75</i> all stats )</span>";
...
if ($row["equipR"] =="chakram") {
    echo " <span>( <i class='green'>+5</i>, <i class='blue'>+5</i> )</span>";
...
if ($row["equipR"] =="hatchet") {
    echo " <span>( +3 str, +1 def )</span>";
    $results = $link->query("UPDATE $user SET strmod = strmod +3");
    $results = $link->query("UPDATE $user SET defmod = defmod +1");
}

// -----------------------------------------------------------------pickaxe buff +3 STR, +3 DEF
if ($row["equipR"] =="pickaxe") {
    echo " <span>( +1 str, +3 def )</span>";
    $results = $link->query("UPDATE $user SET strmod = strmod +3");
    $results = $link->query("UPDATE $user SET defmod = defmod +3");
}

// -----------------------------------------------------------------hammer buff +5 STR
if ($row["equipR"] =="hammer") {
    echo " <span>( +5 str )</span>";
    $results = $link->query("UPDATE $user SET strmod = strmod +5");
}
