...
$message = 'HP 100 MP 100!'; include ('update_feed.php'); // --- update feed
}
// --------------------------------------------------------------------------- supercharge HP & MP
if ($input=="supercharge"){
$results = $link->query("UPDATE $user SET hp = hpmax + 100");
$results = $link->query("UPDATE $user SET mp = mpmax + 1");
$message = 'SUPERCHARGE CHEAT!'; include ('update_feed.php'); // --- update feed
}
// --------------------------------------------------------------------------- reset quests
else if ($input=="reset quests"){
...
$message = 'RESET QUESTS CHEAT!'; include ('update_feed.php'); // --- update feed
}
// --------------------------------------------------------------------------- all quests 1 (START)
else if ($input=="all quests start"){
...
$message = 'ALL QUESTS START CHEAT!'; include ('update_feed.php'); // --- update feed
}
// --------------------------------------------------------------------------- get master blade

else if($input=='get master blade' || $input=='get blade') 
{
...
// --------------------------------------------------------------------------- complete quests 1-7
else if ($input=="complete quests 1-7"){
...
$message = 'COMPLETE MISSIONS (1-7) CHEAT!'; include ('update_feed.php'); // --- update feed
}

// --------------------------------------------------------------------------- ZERO OUT STATS

else if ($input=="zero stat"){
...
$message = '[CHEAT] YOU ZERO OUT YOUR STATS!'; include ('update_feed.php'); // --- update feed

}

// --------------------------------------------------------------------------- FREE STUFF
else if ($input=="free stuff"){
// --------------------------------------------------------------------------- FREE 1h
