(function() {
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      uglify: {
        ...
        dist: {
          ...
          src: ['.tmp/src/zoomer.js', '.tmp/src/cropit.js', '.tmp/src/plugin.js'],
    ...
    grunt.registerTask('build', ['coffeelint', 'coffee', 'uglify', 'clean']);
    grunt.registerTask('test', ['coffeelint', 'coffee', 'jasmine', 'clean']);
