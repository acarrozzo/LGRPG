...
// -------------------------------------------------------------------------- ROOM ACTIONS
else if($input=='read signOLD') {  //read sign OLD
...
{	
	...
	echo 'As you attempt to enter the forest you are stopped by a Red Guard.<br/>';
 	$message="<i>As you attempt to enter the Forest you are stopped by a Red Guard. You will need authorization from the Red Guard Captain to enter. Visit him at the Barracks in the town south of here and complete any one of his quests to gain access to the Forest.  </i><br/>";
	include ('update_feed.php'); // --- update feed	
