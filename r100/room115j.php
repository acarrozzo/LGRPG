<?php
							  $roomname = "Champion Arena";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc115j'];
...
{	echo 'You travel west<br/>';
   $message="<i>You travel west</i></br>".$_SESSION['desc115g'];
	include ('update_feed.php'); // --- update feed
...
{	echo 'You travel south<br/>';
   $message="<i>You travel south</i></br>".$_SESSION['desc115i'];
	include ('update_feed.php'); // --- update feed
...
{	echo 'You travel southwest<br/>';
   $message="<i>You travel southwest</i></br>".$_SESSION['desc115h'];
	include ('update_feed.php'); // --- update feed
...
{	echo 'You travel north<br/>';
   $message="<i>You travel north</i></br>".$_SESSION['desc115k'];
	include ('update_feed.php'); // --- update feed
