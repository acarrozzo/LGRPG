<?php
							  $roomname = "Kobold Temple";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc115d'];
...
if ($infight < 1 && $endfight != 1)  // RAND GENERATOR
	{	$rand = rand (1,10);$randrare = rand (1,25);  }	else {$rand=0;$randrare=0;}
// -------------------------------------------------------------------------- INITIALIZE SUPER RARE - Kobold Monk - 1/25!!!
if(($randrare == 1 ) && $infight==0 && $endfight==0) 
	{	$results = $link->query("UPDATE $user SET enemy = 'Kobold Monk'"); include ('battle.php'); }		
// -------------------------------------------------------------------------- INITIALIZE kobold shaman - 4/10
...
{	echo 'You travel southeast<br/>';
   $message="<i>You travel southeast</i></br>".$_SESSION['desc115c'];
	include ('update_feed.php'); // --- update feed
...
{	echo 'You travel south<br/>';
   $message="<i>You travel south</i></br>".$_SESSION['desc115a'];
	include ('update_feed.php'); // --- update feed
