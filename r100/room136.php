<?php
						$roomname = "Abandoned Troll Guard Post";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc136'];
...
{	echo 'You travel west<br/>';
   $message="<i>You travel west</i></br>".$_SESSION['desc137'];
	 include ('update_feed.php'); // --- update feed
...
{	echo 'You travel southwest<br/>';
   $message="<i>You travel southwest</i></br>".$_SESSION['desc135'];
	 include ('update_feed.php'); // --- update feed
...
{	echo 'You travel south<br/>';
   $message="<i>You travel south</i></br>".$_SESSION['desc134'];
	 include ('update_feed.php'); // --- update feed
