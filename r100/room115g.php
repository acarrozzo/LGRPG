<?php
							  $roomname = "Dark Courtyard";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc115g'];
...
{	echo 'You travel west<br/>';
   $message="<i>You travel west</i></br>".$_SESSION['desc115e'];
	include ('update_feed.php'); // --- update feed
...
{	echo 'You travel east<br/>';
   $message="<i>You travel east</i></br>".$_SESSION['desc115j'];
	include ('update_feed.php'); // --- update feed
...
{	echo 'You travel southeast<br/>';
   $message="<i>You travel southeast</i></br>".$_SESSION['desc115i'];
	include ('update_feed.php'); // --- update feed
...
{	echo 'You travel south<br/>';
   $message="<i>You travel south</i></br>".$_SESSION['desc115h'];
	include ('update_feed.php'); // --- update feed
