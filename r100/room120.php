...
{	if ($ringofdexterityIII >= 1)
	 	{ echo $message="<div class='menuAction'><i class='fa fa-times lightred'></i>You already have a Ring of Dexterity III. If you lose it come back here for another free one.</div>"; include ('update_feed.php'); // --- update feed
		}
	else
	 	{ echo $message="<div class='menuAction'><i class='fa fa-arrow-circle-up'></i>You pick up a Ring of Dexterity III off the Forest floor.</div>"; include ('update_feed.php'); // --- update feed
