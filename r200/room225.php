...
else if($input=='complete 20') 
{	if ($KLkoboldmaster >= 1)
	{	echo $message="<div class='questWin'>
		<h3>Quest 20 Completed!</h3>
		<h4>Defeat the Kobold Master</h4>
		Congrats! You have indeed slain the Kobold Master. Welcome to the Wizards Guild! You can enter by heading UP. Your signing bonus is a new Wizard Staff and Wizard Hat!!
	  	<h4>Rewards</h4>
  	  	[ + 500 xp  ]<br />
      	[ + 1000 $currency ]<br />
      	[ + Wizard Hat ]<br/>
