...
{	
	...
	{
	echo $message="<i>You can't go north here until you complete all 3 Red Guard Quests. If you complete any 1 quest here you can access the Forest from the Forest Path.</i><br/>";
	include ('update_feed.php'); // --- update feed	
	}
}
