<?php
						$roomname = "Red Town Back Alley";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc234'];
...
{	echo 'You travel north<br/>';
   $message="<i>You travel north</i></br>".$_SESSION['desc218'];
	include ('update_feed.php'); // --- update feed
...
{	echo 'You travel southeast<br/>';
   $message="<i>You travel southeast</i></br>".$_SESSION['desc233'];
	include ('update_feed.php'); // --- update feed
