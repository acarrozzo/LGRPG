<?php
						$roomname = "Red Town Warriors Way";
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc211'];
...
{  echo 'You travel south<br/>';
   $message="<i>You travel south</i></br>".$_SESSION['desc210'];
	 include ('update_feed.php'); // --- update feed
...
{	echo 'You travel north<br/>';
   $message="<i>You travel north</i></br>".$_SESSION['desc212'];
	include ('update_feed.php'); // --- update feed
