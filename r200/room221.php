...
if($input=='info 21') { 
		echo $message="<div class='menuAction'><strong class='green px30'>Quest 21 Info</strong><br>
...
else if($input=='complete 21') 
{	if ($flower >= 2)
	{	echo $message="<div class='questWin'>
		<h3>Quest 21 Completed!</h3>
		<h4>Twice as Nice</h4>
		Congrats! You have picked 2 flowers! Very difficult i'm sure. You get 5 wings and 5 gills potions. You are now ready to enter the Blue Ocean and what lies below.
	  	<h4>Rewards</h4>
  	  	[ + 200 xp  ]<br />
      	[ + 200 $currency ]<br />
      	[ + 5 Wings Potions ]<br/>
	...
	{	echo $message="<div class='menuAction'><strong class='green px30'>Quest 21 Not Complete</strong><br>
...
{	if ($cookedmeat >= 5)
	...
	{	echo $message="<div class='menuAction'><strong class='green px30'>Quest 22 Not Complete</strong><br>
...
if($input=='info 23') { 
		echo $message="<div class='menuAction'><strong class='green px30'>Quest 23 Info</strong><br>
...
{	if ($KLmasterthief >= 1)
	...
	{	echo $message="<div class='menuAction'><strong class='green px30'>Quest 23 Not Complete</strong><br>
