...
if(($rand == 1 ) && $infight==0 && $endfight==0) 
	...
	{	
		$rand2 = rand(1,5);
		if($rand2 == 1 ) { $results = $link->query("UPDATE $user SET enemy = 'Steel Rat'"); include ('battle.php'); } // - 1/
		if($rand2 == 2 ) { $results = $link->query("UPDATE $user SET enemy = 'Steel Crab'"); include ('battle.php'); } //
		if($rand2 == 3 ) { $results = $link->query("UPDATE $user SET enemy = 'Steel Scorpion'"); include ('battle.php'); } // - 1/
