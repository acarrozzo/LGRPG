...
while ($row = $result->fetch_assoc()) {
    ...
    if (($input=='craft' || $input=='CRAFT' || $input=='open crafting menu')|| ($input=='NO MORE!!!')) {
        ...
        } elseif ($crafting>= 1 && ($craftingtable == 0 || $craftingtable !=$room)) {
        ...
        // -------------------------------------------------------------------------- CRAFT FULL WITH TABLE! - ADVANCED
        // -------------------------------------------------------------------------- CRAFT FULL WITH TABLE! - ADVANCED
        elseif ($crafting>= 1 && $craftingtable==$room) {
    ...
    } elseif (($crafting>= 1 && $craftingtable==$room && $input == 'craft w/ wood...')&& ($input=='NO MORE!!!')) {
    ...
    if ($dagger >= 1 && $wood >= 1 && $hammer >=1) { // ------------------------------------------------------------------ javelin
        ...
        include('update_feed.php'); // --- update feed
    } elseif (($crafting>= 1 && $craftingtable==$room && $input == 'craft w/ leather...')&& ($input=='NO MORE!!!')) {
    ...
    elseif ($craftingtable==$room && $crafting >= 1 && $hammer >=1 && $input=='craft javelin' && $dagger >=1 && $wood >=1) {
    ...
    elseif ($craftingtable==$room && $crafting >= 2 && $input=='craft iron javelin' && ($ironhammer >=1 || $steelhammer >=1 || $mithrilhammer >=1) && $irondagger >=1 && $wood >=1) {
...
if ($input=='list materials' || $input=='list my materials') {
    $message = '<h3>Materials List</h3>';
    include('update_feed.php');
    if ($rawmeat > 0) {
        $message='<span>'.$rawmeat.'x </span> raw meat<br/>';
        include('update_feed.php');
    }
    if ($redberry > 0) {
        $message='<span>'.$redberry.'x </span> redberry<br/>';
        include('update_feed.php');
    }
    if ($blueberry > 0) {
        $message='<span>'.$blueberry.'x </span> blueberry<br/>';
        include('update_feed.php');
    }
    if ($sand > 0) {
        $message='<span>'.$sand.'x </span> sand<br/>';
        include('update_feed.php');
    }
    if ($glass > 0) {
        $message='<span>'.$glass.'x </span> glass<br/>';
        include('update_feed.php');
    }
    if ($bottle > 0) {
        $message='<span>'.$bottle.'x </span> bottle<br/>';
        include('update_feed.php');
    }
    if ($string > 0) {
        $message='<span>'.$string.'x </span> string<br/>';
        include('update_feed.php');
    }
    if ($dagger > 0) {
        $message='<span>'.$dagger.'x </span> dagger<br/>';
        include('update_feed.php');
    }
    if ($leather > 0) {
        $message='<span>'.$leather.'x </span> <span class="brown"> leather</span><br/>';
        include('update_feed.php');
    }
    if ($wood > 0) {
        $message='<span>'.$wood.'x </span> <span class="brown"> wood</span><br/>';
        include('update_feed.php');
    }
    if ($stone > 0) {
        $message='<span>'.$stone.'x </span> <span class="darkestgray"> stone</span><br/>';
        include('update_feed.php');
    }
    if ($iron > 0) {
        $message='<span>'.$iron.'x </span> <span class="brown"> iron</span><br/>';
        include('update_feed.php');
    }
}
