...
if ($roomID=='000') {
    ...
    include("roomdesc/000.php");   // execute the file
    $_SESSION['desc000'] = ob_get_contents();    // get the contents from the buffer
    ob_end_clean();                  // stop buffering and discard contents
}

if ($roomID=='001') {
    ob_start();                      // start capturing output
    include("roomdesc/001.php");   // execute the file
    $_SESSION['desc001'] = ob_get_contents();    // get the contents from the buffer
    ob_end_clean();                  // stop buffering and discard contents
}
...
//$_SESSION['desc001'] = include("roomdesc/001.php");
//$_SESSION['desc001'] = file_get_contents("roomdesc/001.php");



$_SESSION['desc001x'] = <<<HTML
	<html><div class="roomBox">
...
if ($roomID=='003') {
    ob_start();                      // start capturing output
include("roomdesc/003.php");   // execute the file
$_SESSION['desc003'] = ob_get_contents();    // get the contents from the buffer
ob_end_clean();                  // stop buffering and discard contents
}
if ($roomID=='003x') {
...
$_SESSION['desc003x'] = <<<HTML
	<html><div class="roomBox">
    <span class="icon brown">$icon</span>
	<h3 class="brown">Old Man</h3>
	<h4>Wood Cabin</h4>
	<p>Inside the cabin you are greeted by an old man. He insists you make yourself at home and stay as long as you like. Start and complete your first quests here.</p>
