...
$str = $row['str']; $strincrease = $str + 1;
$dex = $row['dex']; $dexincrease = $dex + 1;
$mag = $row['mag']; $magincrease = $mag + 1;
$def = $row['def']; $defincrease = $def + 1; 
...
{	if($bp<1) {echo $message=$notenoughbp;include ('update_feed.php');$funflag=1;}
	else { echo $message = 'You spend 1 BP and increase your STR to '.$strincrease.'</br>';	
		$query = $link->query("UPDATE $user SET str = str + 1"); 
		$query = $link->query("UPDATE $user SET bp = bp - 1"); 
		include ('update_feed.php'); $funflag=1; } 
}
if($input=='+10 str') 
{	if($bp<10) {echo $message=$notenoughbp;include ('update_feed.php');$funflag=1;}
	else { echo $message = 'You spend 10 BP and increase your STR to '.$strincrease10.'</br>';	
...
else if($input=='increase dex' || $input=='+1 dex') 
{	if($bp<1) {echo $message=$notenoughbp;include ('update_feed.php');$funflag=1;}
	else { echo $message = 'You spend 1 BP and increase your DEX to '.$dexincrease.'</br>';	
...
if($input=='+10 dex') 
{	if($bp<10) {echo $message=$notenoughbp;include ('update_feed.php');$funflag=1;}
	else { echo $message = 'You spend 10 BP and increase your dex to '.$dexincrease10.'</br>';	
		$query = $link->query("UPDATE $user SET dex = dex + 10"); 
		$query = $link->query("UPDATE $user SET bp = bp - 10"); 
		include ('update_feed.php'); $funflag=1; } 
}	
else if($input=='increase mag' || $input=='+1 mag') 
{	if($bp<1) {echo $message=$notenoughbp;include ('update_feed.php');$funflag=1;}
	else { echo $message = 'You spend 1 BP and increase your MAG to '.$magincrease.'</br>';	
...
if($input=='+10 mag') 
{	if($bp<10) {echo $message=$notenoughbp;include ('update_feed.php');$funflag=1;}
	else { echo $message = 'You spend 10 BP and increase your mag to '.$magincrease10.'</br>';	
		$query = $link->query("UPDATE $user SET mag = mag + 10"); 
		$query = $link->query("UPDATE $user SET bp = bp - 10"); 
		include ('update_feed.php'); $funflag=1; } 
}	
	
else if($input=='increase def' || $input=='+1 def') 
{	if($bp<1) {echo $message=$notenoughbp;include ('update_feed.php');$funflag=1;}
	else { echo $message = 'You spend 1 BP and increase your DEF to '.$defincrease.'</br>';	
...
if($input=='+10 def') 
{	if($bp<10) {echo $message=$notenoughbp;include ('update_feed.php');$funflag=1;}
	else { echo $message = 'You spend 10 BP and increase your def to '.$defincrease10.'</br>';	
