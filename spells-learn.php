...
{	 
	if($sp<$fireball_cost && $fireball_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
...
{	 
	if($sp<$frostball_cost && $frostball_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($frostball_cost <= $frostball_max && $frostball_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $frostball_cost SP)
...
{	 
	if($sp<$poisondart_cost && $poisondart_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($poisondart_cost <= $poisondart_max && $poisondart_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $poisondart_cost SP)
...
{	 
	if($sp<$atomicblast_cost && $atomicblast_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($atomicblast_cost <= ($atomicblast_max+10) && $atomicblast_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $atomicblast_cost SP)
...
if($input=='max heal') 
{	 
	if($sp<$heal_cost && $heal_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($heal_cost <= $heal_max && $heal_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $heal_cost SP)
...
{	 
	if($sp<$regenerate_cost && $regenerate_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($regenerate_cost <= $regenerate_max && $regenerate_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $regenerate_cost SP)
...
{	if ($antidote_cost == 'max') {
	...
	else if($sp<$antidote_cost) {echo $message=$notenoughsp;include ('update_feed.php');}
	else { 
		echo $message = "
		<div class='learnBox'>
...
{	 
	if($sp<$antidote_cost && $antidote_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($antidote_cost <= $antidote_max && $antidote_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $antidote_cost SP)
...
{	 
	if($sp<$magicarmor_cost && $magicarmor_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($magicarmor_cost <= $magicarmor_max && $magicarmor_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $magicarmor_cost SP)
...
{	 
	if($sp<$ironskin_cost && $ironskin_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($ironskin_cost <= $ironskin_max && $ironskin_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $ironskin_cost SP)
...
if($input=='max wings') 
{	 
	if($sp<$wings_cost && $wings_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($wings_cost <= $wings_max && $wings_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $wings_cost SP)
...
if($input=='max gills') 
{	 
	if($sp<$gills_cost && $gills_cost !='max') {echo $message=$notenoughsp;include ('update_feed.php');}
	
	else while ($gills_cost <= $gills_max && $gills_cost <= $sp) 
	{
		echo $message = "
		<div class='learnBox'>
		(You spend $gills_cost SP)
